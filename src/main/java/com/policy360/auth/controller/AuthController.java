...
public class AuthController extends BaseController{
    ...
    public ResponseEntity<ApiResponse<UserResponseDto>> registerUser(
        ...
        UserResponseDto responseDto = userService.registerCustomer(requestDto);

        return ResponseEntity
                .status(201)
                .body(ApiResponse.success("User registered successfully", responseDto, request.getRequestURI()));
    }
